...
from models.HCTUnet import HCTUnet
import configs.HCTUnet_configs as configs
...
if __name__ == "__main__":
    ...
    CONFIGS = {
        'HCTUnet': configs.get_HCTUnet_configs(),
    }

    args.is_pretrain = True

    model = HCTUnet(config=CONFIGS[args.model_name], img_size=args.img_size, n_classes=args.num_classes).cuda()
    msg = model.load_state_dict(torch.load(args.model_weight))
    print("HCTUnet Model: ", msg)
